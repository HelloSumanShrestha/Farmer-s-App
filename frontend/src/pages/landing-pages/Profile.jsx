...
const ProfileSection = () => {
    ...
    useEffect(() => {
        if (profile) {
            setFormData({ customerId: customerId, customerName: profile.customerName, customerEmail: profile.customerEmail, customerPassword: customerPassword });
        }
    }, [profile]);
    ...
    const fetchProfileData = async () => {
        ...
        const handleCancelEdit = () => {
            ...
            const handleCancelEdit = () => {
                setEditMode(false);
                setFormData({ customerId: customerId, customerName: profile.customerName, customerEmail: profile.customerEmail });
            };
